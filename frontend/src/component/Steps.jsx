...
Steps.defaultProps = {
  step1Description:
    'Explore our wide range of technology devices including computers, phones, tablets, and more.',
  step3Description:
    "Once you've made your decision, simply add the item to your cart and proceed to checkout.",
  step2Title: 'Choose your favorite',
  step2Description:
    'Select the device that best fits your needs and preferences from our curated collection.',
  step1Title: 'Browse our selection',
  step3Title: 'Place your order',
  step4Description:
    'Receive your technology device and start enjoying its features and capabilities right away.',
